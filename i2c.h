...
void ResetI2C(void);
void RequestBytesI2C(uint8_t address, uint8_t *rx_destination_ptr,
...
void SendBytesI2C(uint8_t address, uint8_t *tx_source_ptr,
  uint8_t tx_source_len);
void SendThenReceiveI2C(uint8_t address, uint8_t *tx_source_ptr,
